          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            {sections.map((s, i) => (
              <section key={s.group} className="mb-5 last:mb-0">
                ...
                {/* 🪦 ЗДЕСЬ БЫЛ РЯД БЕЙДЖЕЙ СО ВСЕМИ РОЛЯМИ СЛОЯ, и он объяснялся так:
                    «человек видит, из чего слой состоит: какие роли здесь вообще
                    бывают… вопрос у ящика — не 'кто я', а 'как устроен доступ'»
                    (решение владельца 2026-08-15).

                    🔒 СНЯТО ВЛАДЕЛЬЦЕМ 2026-08-25: «в выдвижном ящике скрыть бейджи
                    ролей». Прежнее решение отвечало на вопрос об устройстве доступа —
                    в шаблоне, где ящик и был витриной архитектуры. Здесь ящик —
                    рабочая навигация, и семь строк ролей отделяли человека от
                    ссылок, ради которых он его открыл. Свои роли по-прежнему
                    названы внизу, у почты. */}
