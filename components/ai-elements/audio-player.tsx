...
export const AudioPlayerPlayButton = ({
  ...
  <MediaPlayButton
    className={cn(buttonVariants({ variant: "outline", size: "icon-sm" }), "bg-transparent", className)}
...
export const AudioPlayerSeekBackwardButton = ({
  ...
  <MediaSeekBackwardButton
    className={cn(buttonVariants({ variant: "outline", size: "icon-sm" }), "bg-transparent")}
